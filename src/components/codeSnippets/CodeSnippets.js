    ...
    language == 'pythonFlask'
      ...
      <div className={`${className == 2 ? 'code-snippet-container-2' : 'code-snippet-container'} rounded-3 p-4`}>
        <p className='m-0 p-0 small-txt mb-0'>
          <span className='txt-A020F0'>from</span> <span className='txt-ADD8E6'>flask</span> <span className='txt-A020F0'>import</span> <span className='txt-ADD8E6'>Flask</span>
        </p>
        <p className='m-0 p-0 small-txt mb-0'>
          <span className='txt-A020F0'>from</span> <span className='txt-ADD8E6'>http</span> <span className='txt-A020F0'>import</span> <span className='txt-ADD8E6'>HTTPStatus</span>
        </p>
        <p className='m-0 p-0 small-txt mb-2'>
          <span className='txt-ADD8E6'>app</span> <span className='txt-FFF'>=</span> <span className='txt-C0C083'>Flask</span><span className='txt-A020F0'>{'('}</span><span className='txt-E99287'>"__name__"</span><span className='txt-A020F0'>{')'}</span>
        </p>
        <p className='small-txt mb-0'>
          <span className='txt-C9C901'>{'@'}</span><span className='txt-ADD8E6'>app</span><span className='txt-FFF'>.</span><span className='txt-C0C083'>get</span><span className='txt-D6E225'>{'('}</span><span className='txt-E99287'>"/"</span><span className='txt-D6E225'>{')'}</span>
        </p>
        <p className='m-0 p-0 mb-0 small-txt'>
          <span className='txt-A020F0'>def</span> <span className='txt-C0C083'>index</span><span className='txt-C9C901'>{'():'}</span>
        </p>
        <p className='m-0 p-0 small-txt px-4 mb-0'>
          <span className='txt-A020F0'>return <span className='txt-C9C901'>"""</span></span>
        </p>
        <p className='px-4 mb-0'>
          <p className='m-0 p-0 small-txt px-4'>
            <span className='txt-6C6C6D'>{'<'}</span><span className='txt-4D5BCE'>h1</span><span className='txt-6C6C6D'>{'>'}</span>
          </p>
        </p>
        <p className='px-4 mb-0'>
          <p className='px-4 mb-0'>
            <p className='px-4 m-0 p-0 small-txt'>
              <span className='txt-FFF'>Hello<span className='txt-FFF'>,</span> World!</span>
            </p>
          </p>
        </p>
        <p className='px-4 mb-0'>
        ...
        <p className='px-4 small-txt mb-0'>
          <span className='txt-C9C901'>"""</span><span className='txt-FFF'>,</span> <span className='txt-ADD8E6'>HTTPStatus</span><span className='txt-FFF'>.</span><span className='txt-C0C083'>OK</span><span className='txt-FFF'>.</span><span className='txt-C0C083'>value</span>
        </p>
        <p className='small-txt mb-0 d-flex justify-content-end'>
          <span className='txt-C0C083'>-Python Flask</span>
        </p>
      </div>
      :
